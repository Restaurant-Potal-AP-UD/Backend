...
// *
// * The tests use Spring Boot Test, TestRestTemplate, and MockMvc for setup and
// execution.
...
// tokenGood = new
// LoginResponseDTO(userservice.getUserByEmail(uniqueEmail).getId(),
// userDTO.getUsername());
// }
...
// this.tokenGood.getValue().get("token"));
...
// this.updt = new UpdatePrimaryInfoDTO("Sebastian", "Avendaño", "perra.com",
// "holauwu@gmail.com");
// HttpHeaders headers = new HttpHeaders();
// headers.set("Authorization", "Bearer " +
// this.tokenGood.getValue().get("token"));

// HttpEntity<UpdatePrimaryInfoDTO> requestEntity = new HttpEntity<>(updt,
// headers);
...
// headers.set("Authorization",
// "Bearer
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJlM2NkZmM4Yi0yN2VmLTQ4YzctOGJlYi04MmY3NjZhM2UzZmMiLCJpYXQiOjE2OTM1NjYwMjUsImV4cCI6Nzc3NTYwMDAyNX0.KIhq13nlJyw2Tw77LHu-p2Q4cUwVinF-B54v6EdOiq0");
