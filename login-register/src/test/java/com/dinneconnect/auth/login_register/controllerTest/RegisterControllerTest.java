 ...
 * 
 * The tests use Spring Boot Test and TestRestTemplate for setup and execution.
...
public class RegisterControllerTest {
    ...
    public void setup() {
        ...
        this.userDTO = new RegisterDTO("sebas", "aven", "save", "sebas@gamail.com", "123456782209");
    ...
    public void testCorrectRegister() {
        userDTO = new RegisterDTO("sebas2", "aven2", "save2", "sebas222@gamail.com", "1234567809");
        ResponseEntity<Map> response = restTemplate.postForEntity("/api/post-user/", this.userDTO, Map.class);
    ...
    public void testDuplicateEmail() {
        userDTO = new RegisterDTO("sebas", "aven", "save1", "sebas@gamail.com", "123456782209");
        ResponseEntity<Map> response = restTemplate.postForEntity("/api/post-user/", userDTO, Map.class);
    ...
    public void testDuplicaUsername() {
        userDTO = new RegisterDTO("sebas", "aven", "save", "sebas12@gamail.com", "123456782209");
        ResponseEntity<Map> response = restTemplate.postForEntity("/api/post-user/", userDTO, Map.class);
