...
// RegisterDTO user_dto = new RegisterDTO("John", "Doe", "john.doe",
...
// ResponseEntity<String> response = userService.updatePassword(userId,
// newPassword);
...
// assertEquals("User with ID " + userId + " does not exist.",
